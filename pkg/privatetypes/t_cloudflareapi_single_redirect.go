...
func init() {
	Register(TypeCLOUDFLAREAPISINGLEREDIRECT, "CLOUDFLAREAPI_SINGLE_REDIRECT",
		func() dnsv2.RR { return new(CLOUDFLAREAPISINGLEREDIRECT) },
		privatetypesrdata.MakeCLOUDFLAREAPISINGLEREDIRECT)
}
